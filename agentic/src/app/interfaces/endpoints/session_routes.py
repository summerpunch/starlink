...
from src.app.interfaces.schemas.event import EventMapper
from src.app.interfaces.schemas.session import CreateSessionResponse, ListSessionResponse, GetSessionResponse, \
    FileReadResponse, FileReadRequest, ShellReadResponse, ShellReadRequest, GetSessionFilesResponse, ChatRequest, \
    ListSessionItem
from src.app.interfaces.service_dependencies import get_session_service, get_agent_service
from sse_starlette import EventSourceResponse, ServerSentEvent
from starlette.websockets import WebSocket, WebSocketDisconnect
from websockets import ConnectionClosed

from agentic.src.app.application.errors.exceptions import NotFoundError
...
@router.get(
    ...
    summary="获取会话列表基础信息",
    description="获取 agentic 项目中所有任务会话基础信息列表",
)
async def get_all_sessions(
        session_service: SessionService = Depends(get_session_service),
) -> Response[ListSessionResponse]:
    """获取 agentic 项目中所有任务会话基础信息列表"""
    sessions = await session_service.get_all_sessions()
    session_items = [
        ListSessionItem(
            session_id=session.id,
