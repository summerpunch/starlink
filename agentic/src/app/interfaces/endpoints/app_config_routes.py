...
from src.app.domain.models.app_config import LLMConfig, AgentConfig
from src.app.domain.models.app_config import MCPConfig
from src.app.interfaces.schemas import Response
from src.app.interfaces.schemas.app_config import ListMCPServerResponse, ListA2AServerResponse
from src.app.interfaces.service_dependencies import get_app_config_service
...
@router.get(
    ...
    summary="获取a2a服务器列表",
    description="获取 agentic 项目中的所有已配置的a2a服务列表",
)
...
@router.post(
    ...
    response_model=Response[Optional[Dict]],
    summary="新增a2a服务器",
    description="为 agentic 项目新增a2a服务器",
)
