...
from src.app.application.errors.exceptions import AppException
...
def register_exception_handlers(app: FastAPI) -> None:
    """处理 agentic 项目中所有的异常并进行统一处理，涵盖：自定义业务状态异常、HTTP异常、通用异常"""

    @app.exception_handler(AppException)
    async def app_exception_handler(req: Request, e: AppException) -> JSONResponse:
        """处理 agentic 业务异常，将所有状态统一响应结构"""
    ...
    async def exception_handler(req: Request, e: Exception) -> JSONResponse:
        """处理 agentic 中抛出的未定义的任意一场，将状态码统一设置为500"""
