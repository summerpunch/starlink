...
from src.app.domain.models.event import BaseEvent
...
from src.app.domain.repositories.session_repository import SessionRepository
from src.app.infrastructure.models import SessionModel
